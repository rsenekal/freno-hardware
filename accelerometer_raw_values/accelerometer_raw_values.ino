...
void loop()
{
  ...
  accel_t_gyro.value.x_accel = accel_t_gyro.value.x_accel / 16384;
  accel_t_gyro.value.y_accel = accel_t_gyro.value.y_accel / 16384;
  accel_t_gyro.value.z_accel = accel_t_gyro.value.z_accel / 16384;
