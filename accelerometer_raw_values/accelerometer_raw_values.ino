...
void loop()
{
  ...
  accel_t_gyro.value.x_accel = (accel_t_gyro.value.x_accel / 16384) * 9.8;
  accel_t_gyro.value.y_accel = (accel_t_gyro.value.y_accel / 16384) * 9.8;
  accel_t_gyro.value.z_accel = (accel_t_gyro.value.z_accel / 16384) * 9.8;
  ...
  accel_t_gyro.value.z_gyro = accel_t_gyro.value.z_gyro / 131.0;
  accel_t_gyro.value.y_gyro = accel_t_gyro.value.y_gyro / 131.0;
  accel_t_gyro.value.x_gyro = accel_t_gyro.value.x_gyro / 131.0;
